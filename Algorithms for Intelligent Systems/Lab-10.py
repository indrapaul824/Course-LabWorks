...
# Name:        Lab-10.py / PlanningGraph
# Purpose:     Implementation of Graph Planning Algorithm. Reads the initial 
# 			   state, goal and each action consisting of the pre-condition and 
#			   effect as the format in pddl.txt as input and prints the actions 
# 			   and states at each level until it reaches the goal and returns 
#  			   the solution plan as a set of actions.
# Input:	   Initial state, goal and each action consisting of the pre-condition
# 			   and effect as the format in pddl.txt
# Output:	   Prints the following:
# 			   1. All of the corresponding mutexes(IS, CN, I, NL, IE) at each level.
# 			   2. All layers of states and actions.
# 			   2. The final Solution Path
# -------------------------------------------------------------------------------------
